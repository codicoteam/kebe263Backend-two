// One-off migration / startup reconcile: drops the stale `location: 2dsphere` indexes
// on Property and ServiceProvider (which crashed every save with "Can't extract geo keys"
...
//
// Run manually against an existing DB:
//   node scripts/fixGeoIndexes.js
//
// Or import `reconcileGeoIndexes` from server startup to auto-heal on redeploy.
...
const reconcileGeoIndexes = async () => {
  ...
  console.log('Geo index reconcile complete.');
};
...
module.exports = { reconcileGeoIndexes };
